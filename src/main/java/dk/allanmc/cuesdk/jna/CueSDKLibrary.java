...
public interface CueSDKLibrary extends Library {
	...
	public static final NativeLibrary JNA_NATIVE_LIB = NativeLibrary.getInstance(CueSDKLibrary.JNA_LIBRARY_NAME);
	public static final CueSDKLibrary INSTANCE = (CueSDKLibrary)Native.loadLibrary(CueSDKLibrary.JNA_LIBRARY_NAME, CueSDKLibrary.class);
	/**
